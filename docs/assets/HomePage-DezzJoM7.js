const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-xMOrffVN.js","assets/index-mpwlQoeZ.css"])))=>i.map(i=>d[i]);
import{i as Ke,a as Ie,u as ge,m as Ve,r as u,M as Ee,b as ze,f as Pe,c as Ce,d as Y,e as De,g as $e,h as Re,j as fe,k as Te,l as Le,n as Ge,o as Fe,s as He,p as Oe,V as Be,q as Ne,t as We,v as Ye,S as Ze,H as Ue,w as N,x as Qe,y as Xe,z as Je,A as n,B as a,C as T,D as qe,E as P,F as et,G as tt,I as ae,J as nt,K as H,L as xe,N as oe,R as rt,O as h,_ as it,P as se,Q as at,T as ot,U as st,W as ct,X as lt,Y as dt,Z as mt,$ as pt,a0 as X}from"./index-xMOrffVN.js";const ut=(e,t,r)=>{const i=t-e;return((r-e)%i+i)%i+e};function ye(e,t){return Ke(e)?e[ut(0,e.length,t)]:e}class ht{constructor(t){this.stop=()=>this.runAll("stop"),this.animations=t.filter(Boolean)}get finished(){return Promise.all(this.animations.map(t=>t.finished))}getAll(t){return this.animations[0][t]}setAll(t,r){for(let i=0;i<this.animations.length;i++)this.animations[i][t]=r}attachTimeline(t){const r=this.animations.map(i=>i.attachTimeline(t));return()=>{r.forEach((i,o)=>{i&&i(),this.animations[o].stop()})}}get time(){return this.getAll("time")}set time(t){this.setAll("time",t)}get speed(){return this.getAll("speed")}set speed(t){this.setAll("speed",t)}get state(){return this.getAll("state")}get startTime(){return this.getAll("startTime")}get duration(){return ce(this.animations,"duration")}get iterationDuration(){return ce(this.animations,"iterationDuration")}runAll(t){this.animations.forEach(r=>r[t]())}play(){this.runAll("play")}pause(){this.runAll("pause")}cancel(){this.runAll("cancel")}complete(){this.runAll("complete")}}function ce(e,t){let r=0;for(let i=0;i<e.length;i++){const o=e[i][t];o!==null&&o>r&&(r=o)}return r}class gt extends ht{then(t,r){return this.finished.finally(t).then(()=>{})}}function ft(...e){const t=!Array.isArray(e[0]),r=t?0:-1,i=e[0+r],o=e[1+r],s=e[2+r],c=e[3+r],p=Ie(o,s,c);return t?p(i):p}function ve(e){const t=ge(()=>Ve(e)),{isStatic:r}=u.useContext(Ee);if(r){const[,i]=u.useState(e);u.useEffect(()=>t.on("change",i),[])}return t}function be(e,t){const r=ve(t()),i=()=>r.set(t());return i(),ze(()=>{const o=()=>Pe.preRender(i,!1,!0),s=e.map(c=>c.on("change",o));return()=>{s.forEach(c=>c()),Ce(i)}}),r}function xt(e){Y.current=[],e();const t=be(Y.current,e);return Y.current=void 0,t}function yt(e,t,r,i){if(typeof e=="function")return xt(e);const o=typeof t=="function"?t:ft(t,r,i);return Array.isArray(e)?le(e,o):le([e],([s])=>o(s))}function le(e,t){const r=ge(()=>[]);return be(e,()=>{r.length=0;const i=e.length;for(let o=0;o<i;o++)r[o]=e[o].get();return t(r)})}function J(e){return typeof e=="object"&&!Array.isArray(e)}function we(e,t,r,i){return typeof e=="string"&&J(t)?De(e,r,i):e instanceof NodeList?Array.from(e):Array.isArray(e)?e:[e]}function vt(e,t,r){return e*(t+1)}function de(e,t,r,i){return typeof t=="number"?t:t.startsWith("-")||t.startsWith("+")?Math.max(0,e+parseFloat(t)):t==="<"?r:t.startsWith("<")?Math.max(0,r+parseFloat(t.slice(1))):i.get(t)??e}function bt(e,t,r){for(let i=0;i<e.length;i++){const o=e[i];o.at>t&&o.at<r&&(Re(e,o),i--)}}function wt(e,t,r,i,o,s){bt(e,o,s);for(let c=0;c<t.length;c++)e.push({value:t[c],at:$e(o,s,i[c]),easing:ye(r,c)})}function _t(e,t){for(let r=0;r<e.length;r++)e[r]=e[r]/(t+1)}function jt(e,t){return e.at===t.at?e.value===null?1:t.value===null?-1:0:e.at-t.at}const St="easeInOut";function kt(e,{defaultTransition:t={},...r}={},i,o){const s=t.duration||.3,c=new Map,p=new Map,g={},y=new Map;let M=0,m=0,C=0;for(let A=0;A<e.length;A++){const f=e[A];if(typeof f=="string"){y.set(f,m);continue}else if(!Array.isArray(f)){y.set(f.name,de(m,f.at,M,y));continue}let[w,v,x={}]=f;x.at!==void 0&&(m=de(m,x.at,M,y));let b=0;const V=(_,j,S,K=0,l=0)=>{const d=Mt(_),{delay:E=0,times:k=Te(d),type:W="keyframes",repeat:L,repeatType:tr,repeatDelay:nr=0,...Ae}=j;let{ease:z=t.ease||"easeOut",duration:I}=j;const q=typeof E=="function"?E(K,l):E,ee=d.length,te=Fe(W)?W:o?.[W||"keyframes"];if(ee<=2&&te){let D=100;if(ee===2&&It(d)){const $=d[1]-d[0];D=Math.abs($)}const G={...Ae};I!==void 0&&(G.duration=He(I));const F=Le(G,D,te);z=F.ease,I=F.duration}I??(I=s);const ne=m+q;k.length===1&&k[0]===0&&(k[1]=1);const re=k.length-d.length;if(re>0&&Ge(k,re),d.length===1&&d.unshift(null),L){I=vt(I,L);const D=[...d],G=[...k];z=Array.isArray(z)?[...z]:[z];const F=[...z];for(let $=0;$<L;$++){d.push(...D);for(let R=0;R<D.length;R++)k.push(G[R]+($+1)),z.push(R===0?"linear":ye(F,R-1))}_t(k,L)}const ie=ne+I;wt(S,d,z,k,ne,ie),b=Math.max(q+I,b),C=Math.max(ie,C)};if(fe(w)){const _=me(w,p);V(v,x,pe("default",_))}else{const _=we(w,v,i,g),j=_.length;for(let S=0;S<j;S++){v=v,x=x;const K=_[S],l=me(K,p);for(const d in v)V(v[d],At(x,d),pe(d,l),S,j)}}M=m,m+=b}return p.forEach((A,f)=>{for(const w in A){const v=A[w];v.sort(jt);const x=[],b=[],V=[];for(let j=0;j<v.length;j++){const{at:S,value:K,easing:l}=v[j];x.push(K),b.push(Oe(0,C,S)),V.push(l||"easeOut")}b[0]!==0&&(b.unshift(0),x.unshift(x[0]),V.unshift(St)),b[b.length-1]!==1&&(b.push(1),x.push(null)),c.has(f)||c.set(f,{keyframes:{},transition:{}});const _=c.get(f);_.keyframes[w]=x,_.transition[w]={...t,duration:C,ease:V,times:b,...r}}}),c}function me(e,t){return!t.has(e)&&t.set(e,{}),t.get(e)}function pe(e,t){return t[e]||(t[e]=[]),t[e]}function Mt(e){return Array.isArray(e)?e:[e]}function At(e,t){return e&&e[t]?{...e,...e[t]}:{...e}}const Kt=e=>typeof e=="number",It=e=>e.every(Kt);function Vt(e,t){return e in t}class Et extends Be{constructor(){super(...arguments),this.type="object"}readValueFromInstance(t,r){if(Vt(r,t)){const i=t[r];if(typeof i=="string"||typeof i=="number")return i}}getBaseTargetFromProps(){}removeValueFromRenderState(t,r){delete r.output[t]}measureInstanceViewportBox(){return Ne()}build(t,r){Object.assign(t.output,r)}renderInstance(t,{output:r}){Object.assign(t,r)}sortInstanceNodePosition(){return 0}}function zt(e){const t={presenceContext:null,props:{},visualState:{renderState:{transform:{},transformOrigin:{},style:{},vars:{},attrs:{}},latestValues:{}}},r=We(e)&&!Ye(e)?new Ze(t):new Ue(t);r.mount(e),N.set(e,r)}function Pt(e){const t={presenceContext:null,props:{},visualState:{renderState:{output:{}},latestValues:{}}},r=new Et(t);r.mount(e),N.set(e,r)}function Ct(e,t){return fe(e)||typeof e=="number"||typeof e=="string"&&!J(t)}function _e(e,t,r,i){const o=[];if(Ct(e,t))o.push(Qe(e,J(t)&&t.default||t,r&&(r.default||r)));else{const s=we(e,t,i),c=s.length;for(let p=0;p<c;p++){const g=s[p],y=g instanceof Element?zt:Pt;N.has(g)||y(g);const M=N.get(g),m={...r};"delay"in m&&typeof m.delay=="function"&&(m.delay=m.delay(p,c)),o.push(...Xe(M,{...t,transition:m},{}))}}return o}function Dt(e,t,r){const i=[];return kt(e,t,r,{spring:Je}).forEach(({keyframes:s,transition:c},p)=>{i.push(..._e(p,s,c))}),i}function $t(e){return Array.isArray(e)&&e.some(Array.isArray)}function Rt(e){function t(r,i,o){let s=[],c;if($t(r))s=Dt(r,i,e);else{const{onComplete:g,...y}=o||{};typeof g=="function"&&(c=g),s=_e(r,i,y,e)}const p=new gt(s);return c&&p.finished.then(c),p}return t}const Tt=Rt(),Lt=(e=1024)=>{const[t,r]=u.useState(()=>typeof window>"u"?!1:window.innerWidth<e);return u.useEffect(()=>{const i=()=>{const s=navigator.userAgent||navigator.vendor||window.opera;return/android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(s.toLowerCase())},o=()=>{const s=window.innerWidth<e,c=i();r(s||c)};if(o(),typeof ResizeObserver<"u"){const s=new ResizeObserver(o);return s.observe(document.documentElement),()=>s.disconnect()}else return window.addEventListener("resize",o,{passive:!0}),()=>window.removeEventListener("resize",o)},[e]),t},Gt=()=>{const[e,t]=u.useState(()=>typeof window>"u"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return u.useEffect(()=>{const r=window.matchMedia("(prefers-reduced-motion: reduce)"),i=o=>{t(o.matches)};return r.addEventListener?(r.addEventListener("change",i),()=>r.removeEventListener("change",i)):(r.addListener(i),()=>r.removeListener(i))},[]),e},je=T`
