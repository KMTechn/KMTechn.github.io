...
`,Mt=()=>r.jsx(Ct,{"aria-hidden":"true",children:r.jsx(Ft,{src:"/images/kmtech-globe-logistics-alpha.png",alt:"",loading:"eager",decoding:"async"})}),Pt=n.div`
  width: 100%;
  overflow-x: hidden;
`,Rt=n.section`
  min-height: auto;
...
`,$r=n.div`
  ...
  align-items: center;
  gap: 1.5rem;
`,Zr=n(p.img).attrs({loading:"lazy",decoding:"async"})`
  height: 50px;
  max-width: 140px;
  object-fit: contain;
...
`,Yr=({value:e,suffix:t=""})=>{const i=v.useRef(null),a=C(i,{once:!0}),s=xe(0),m=pt(s,u=>Math.round(u)),[l,d]=v.useState(0);return v.useEffect(()=>{if(a){const u=Et(s,e,{duration:2,ease:"easeOut"}),f=m.on("change",_=>{d(_)});return()=>{u.stop(),f()}}},[a,e,s,m]),r.jsxs(ur,{ref:i,children:[l.toLocaleString(),r.jsx("span",{children:t})]})},Qr=()=>{const{t:e}=Ze(),t=v.useRef(null),i=v.useRef(null),a=v.useRef(null),s=v.useRef(null),m=v.useRef(null),l=v.useRef(null),d=C(i,{once:!0,margin:"-50px"}),u=C(a,{once:!0,margin:"-50px"}),f=C(s,{once:!0,margin:"-50px"}),_=C(l,{once:!0,margin:"-50px"}),h=C(m,{once:!0,margin:"-50px"}),A=[{icon:r.jsx(et,{}),titleKey:"process_home_step1_title",descKey:"process_home_step1_desc"},{icon:r.jsx(ne,{}),titleKey:"process_home_step2_title",descKey:"process_home_step2_desc"},{icon:r.jsx(tt,{}),titleKey:"process_home_step3_title",descKey:"process_home_step3_desc"},{icon:r.jsx(rt,{}),titleKey:"process_home_step4_title",descKey:"process_home_step4_desc"}],I=[{icon:r.jsx(ne,{}),titleKey:"home_service_warehouse_title",descKey:"home_service_warehouse_desc"},{icon:r.jsx(it,{}),titleKey:"home_service_inspection_title",descKey:"home_service_inspection_desc"},{icon:r.jsx(nt,{}),titleKey:"home_service_packaging_title",descKey:"home_service_packaging_desc"},{icon:r.jsx(ae,{}),titleKey:"business_delivery_title",descKey:"business_delivery_summary"}],w=[{icon:r.jsx(at,{}),titleKey:"strong_point_2_title",descKey:"strong_point_2_desc"},{icon:r.jsx(ae,{}),titleKey:"strong_point_5_title",descKey:"strong_point_5_desc"},{icon:r.jsx(ot,{}),titleKey:"strong_point_6_title",descKey:"strong_point_6_desc"}],k=[{value:2140,suffix:"㎡",labelKey:"stats_warehouse_space"},{value:3e3,suffix:"+",labelKey:"stats_pallet_capacity"},{value:40,suffix:"ft x2",labelKey:"metric_container_dock"},{value:16,suffix:"CH",labelKey:"metric_cctv"}],j=[{value:"2,140㎡",labelKey:"hero_proof_facility"},{value:"3,000+",labelKey:"hero_proof_capacity"},{value:"40ft x2",labelKey:"metric_container_dock"},{value:"16CH",labelKey:"metric_cctv"}],x=Qe.slice(0,3),y=Object.entries(Ye.reduce((o,c)=>(o[c.industryKey]=o[c.industryKey]||[],o[c.industryKey].push(c),o),{})).map(([o,c])=>({industry:e(o),icon:o==="partners_industry_automotive"?r.jsx(Ue,{}):r.jsx(Xe,{}),partners:c})),K=v.useRef(null),b=C(K,{once:!0,margin:"-50px"});return r.jsxs(Pt,{children:[r.jsx(Rt,{ref:i,children:r.jsxs(Dt,{children:[r.jsxs(Lt,{initial:{opacity:0,y:30},animate:d?{opacity:1,y:0}:{},transition:{duration:.6},children:[r.jsx(Gt,{initial:{opacity:0},animate:d?{opacity:1}:{},transition:{delay:.2},children:"Global 3PL Solutions"}),r.jsx(Ht,{initial:{opacity:0,y:20},animate:d?{opacity:1,y:0}:{},transition:{delay:.3,duration:.6},children:e("hero_title")}),r.jsx(Bt,{initial:{opacity:0,y:20},animate:d?{opacity:1,y:0}:{},transition:{delay:.4,duration:.6},children:e("hero_subtitle")}),r.jsxs(Ot,{initial:{opacity:0,y:20},animate:d?{opacity:1,y:0}:{},transition:{delay:.5,duration:.6},children:[r.jsxs(Z,{to:"/contact",whileHover:{scale:1.02},whileTap:{scale:.98},children:[e("hero_primary_cta")," ",r.jsx(re,{})]}),r.jsx($t,{to:"/business",whileHover:{scale:1.02},whileTap:{scale:.98},children:e("hero_secondary_cta")})]}),r.jsx(sr,{"aria-label":e("hero_proof_label"),initial:{opacity:0,y:16},animate:d?{opacity:1,y:0}:{},transition:{delay:.6,duration:.5},children:j.map(o=>r.jsxs(cr,{children:[r.jsx(lr,{children:o.value}),r.jsx(dr,{children:e(o.labelKey)})]},o.labelKey))}),r.jsx(Nt,{initial:{opacity:0},animate:d?{opacity:1}:{},transition:{delay:.7,duration:.5},children:r.jsxs(Wt,{href:"mailto:cgpark@kmtechn.com",children:[r.jsx(Je,{})," cgpark@kmtechn.com"]})})]}),r.jsxs(Zt,{ref:t,initial:{opacity:0,y:18},animate:d?{opacity:1,y:0}:{},transition:{delay:.3,duration:.7},children:[r.jsx(Yt,{src:"/images/kmtech-home-network-backdrop.png",alt:"",loading:"eager",decoding:"async"}),r.jsxs(Ut,{children:[r.jsx(Xt,{children:e("hero_visual_label")}),r.jsx(Jt,{children:e("hero_visual_network")})]}),r.jsx(qt,{children:x.map(o=>r.jsxs(er,{children:[r.jsx(tr,{children:e(o.labelKey)}),r.jsx(rr,{children:o.value})]},o.labelKey))}),r.jsx(Qt,{children:r.jsx(Mt,{})}),r.jsxs(ir,{children:[r.jsx(nr,{children:e("hero_visual_flow_label")}),r.jsx(ar,{children:A.map(o=>r.jsxs(or,{children:[o.icon,r.jsx("span",{children:e(o.titleKey)})]},o.titleKey))})]})]})]})}),r.jsx(xr,{ref:s,children:r.jsxs(fr,{children:[r.jsxs(yr,{initial:{opacity:0,y:20},animate:f?{opacity:1,y:0}:{},transition:{duration:.5},children:[r.jsx(H,{children:e("home_section_services_label")}),r.jsx(R,{children:e("home_services_title")}),r.jsx(me,{children:e("home_services_3pl_desc")})]}),r.jsx(br,{children:I.map((o,c)=>r.jsx(ue,{to:"/business",style:{textDecoration:"none",height:"100%"},children:r.jsxs(ve,{initial:{opacity:0,y:30},animate:f?{opacity:1,y:0}:{},transition:{delay:c*.1,duration:.5},children:[r.jsx(vr,{children:o.icon}),r.jsx(wr,{children:e(o.titleKey)}),r.jsx(jr,{children:e(o.descKey)}),r.jsxs(_r,{children:[e("home_services_button")," ",r.jsx(ie,{})]})]})},o.titleKey))})]})}),r.jsx(mr,{ref:a,children:r.jsx(pr,{children:k.map((o,c)=>r.jsxs(hr,{initial:{opacity:0,y:20},animate:u?{opacity:1,y:0}:{},transition:{delay:c*.1,duration:.5},children:[r.jsx(Yr,{value:o.value,suffix:o.suffix}),r.jsx(gr,{children:e(o.labelKey)})]},c))})}),r.jsxs(Er,{ref:l,children:[r.jsxs($,{initial:{opacity:0,y:20},animate:_?{opacity:1,y:0}:{},transition:{duration:.5},children:[r.jsx(H,{children:e("home_section_process_label")}),r.jsx(R,{children:e("process_home_title")}),r.jsx(me,{children:e("process_home_desc")})]}),r.jsx(Cr,{children:A.map((o,c)=>r.jsxs(qe.Fragment,{children:[r.jsxs(Fr,{initial:{opacity:0,y:20},animate:_?{opacity:1,y:0}:{},transition:{delay:c*.15,duration:.5},children:[r.jsx(Mr,{children:o.icon}),r.jsxs(Lr,{children:[r.jsx(Pr,{children:e("process_step_label",{number:c+1})}),r.jsx(Rr,{children:e(o.titleKey)}),r.jsx(Dr,{children:e(o.descKey)})]})]}),c<A.length-1&&r.jsx(Gr,{initial:{opacity:0},animate:_?{opacity:1}:{},transition:{delay:c*.15+.1,duration:.3},children:r.jsx(ie,{})})]},o.titleKey))})]}),r.jsxs(Sr,{ref:m,children:[r.jsxs($,{initial:{opacity:0,y:20},animate:h?{opacity:1,y:0}:{},transition:{duration:.5},children:[r.jsx(H,{children:e("home_section_strengths_label")}),r.jsx(R,{children:e("home_strengths_title")})]}),r.jsx(kr,{children:w.map((o,c)=>r.jsxs(Kr,{initial:{opacity:0,y:20},animate:h?{opacity:1,y:0}:{},transition:{delay:c*.1,duration:.5},children:[r.jsx(Vr,{children:o.icon}),r.jsxs(zr,{children:[r.jsx(Ar,{children:e(o.titleKey)}),r.jsx(Ir,{children:e(o.descKey)})]})]},c))}),r.jsx(Tr,{initial:{opacity:0,y:20},animate:h?{opacity:1,y:0}:{},transition:{delay:.4,duration:.5},children:r.jsxs(Z,{to:"/contact",whileHover:{scale:1.02},whileTap:{scale:.98},children:[e("home_strengths_cta")," ",r.jsx(re,{})]})})]}),r.jsxs(Hr,{ref:K,children:[r.jsxs($,{initial:{opacity:0,y:20},animate:b?{opacity:1,y:0}:{},transition:{duration:.5},children:[r.jsx(H,{children:e("home_section_partners_label")}),r.jsx(R,{children:e("core_customers_title")})]}),r.jsx(Br,{children:y.map((o,c)=>r.jsxs(Or,{initial:{opacity:0,y:20},animate:b?{opacity:1,y:0}:{},transition:{delay:c*.15,duration:.5},children:[r.jsxs(Nr,{children:[o.icon,r.jsx(Wr,{children:o.industry})]}),r.jsx($r,{children:o.partners.map((S,E)=>r.jsx(Zr,{src:S.logo,alt:`${S.name} logo`,$needsBg:S.needsBg,initial:{opacity:0},animate:b?{opacity:1}:{},transition:{delay:c*.15+E*.05,duration:.4}},S.name))})]},o.industry))})]})]})};export{Qr as default};
