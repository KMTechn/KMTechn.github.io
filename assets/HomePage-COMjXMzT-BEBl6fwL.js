const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Globe-Ca0-irBv-wBangyWw.js","assets/index-CxuDO7JV.js","assets/three-bundle-BXl3LOEh.js","assets/index-CJxhOlbf.css"])))=>i.map(i=>d[i]);
import{_ as D}from"./three-bundle-BXl3LOEh.js";import{d as M,X as c,B as e,g,w as $,L as E,v as u,k as L,T as r,E as I,U as T,D as K}from"./index-CxuDO7JV.js";import{I as A,P as H,U as P,x as S,A as R,b as B,p as f,m as j,H as G,z as n,a as b}from"./index-DysxAol--z3qlS56W.js";const w=(i,s=w,a=s.f||(s.f=["assets/Globe-Ca0-irBv.js","assets/three-bundle-DMG25_7Q.js"]))=>i.map(o=>a[o]),O=r.div`
  display: flex;
...
`,X=r.p`
  ...
  font-size: 1rem;
  font-weight: 500;
`;function F(){const{progress:i}=T();return e.jsx(K,{center:!0,children:e.jsxs(O,{children:[e.jsxs(X,{children:[Math.round(i),"% Loaded"]}),e.jsx(U,{children:e.jsx(C,{progress:i})})]})})}const N=c.lazy(()=>I(()=>D(()=>import("./Globe-Ca0-irBv-wBangyWw.js"),__vite__mapDeps([0,1,2,3])),w([0,1]))),Q=r.div`
  width: 100%;
`,V=r(b)`
