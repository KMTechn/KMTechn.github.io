const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Globe-DI8te4ia.js","assets/three-bundle-BZQHYXQX.js"])))=>i.map(i=>d[i]);
import{u as k,j as e,H as T,r as o,C,M as z,c as x,V as M,_ as P}from"./three-bundle-BZQHYXQX.js";import{d as r,L as v}from"./index-DgT-koti.js";import{F as A,a as L,b as E,c as _,S as j,d as F,e as K,f as H,g as b}from"./index-DM6CndqC.js";import{u as I}from"./i18n-D7fTTtVJ.js";import{A as R,m as n}from"./animation-TgGDt1_j.js";import"./icons-B3oAhK0a.js";import"./map-CcgMgzDQ.js";const D=r.div`
  display: flex;
...
`,B=r.p`
  ...
  font-size: 1rem;
  font-weight: 500;
`;function G(){const{progress:t}=k();return e.jsx(T,{center:!0,children:e.jsxs(D,{children:[e.jsxs(B,{children:[Math.round(t),"% Loaded"]}),e.jsx($,{children:e.jsx(V,{progress:t})})]})})}const O=o.lazy(()=>P(()=>import("./Globe-DI8te4ia.js"),__vite__mapDeps([0,1]))),W=r.div`
  width: 100%;
`,N=r(b)`
