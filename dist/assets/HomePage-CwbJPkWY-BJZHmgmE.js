const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Globe-Ca0-irBv-DlOgDdtF.js","assets/index-0D1_OiQj.js","assets/index-CpES_K81.css"])))=>i.map(i=>d[i]);
import{d as D,X as c,B as e,g,w as M,L as $,v as u,k as E,T as r,E as L,_ as I,U as T,D as K}from"./index-0D1_OiQj.js";import{I as A,P as H,U as P,x as S,A as R,b as B,p as f,m as j,H as G,z as n,a as b}from"./index-S6VmQXuv-BDhuIUpk.js";const w=(i,s=w,a=s.f||(s.f=["assets/Globe-Ca0-irBv.js","assets/three-bundle-DMG25_7Q.js"]))=>i.map(o=>a[o]),O=r.div`
  display: flex;
...
`,X=r.p`
  ...
  font-size: 1rem;
  font-weight: 500;
`;function F(){const{progress:i}=T();return e.jsx(K,{center:!0,children:e.jsxs(O,{children:[e.jsxs(X,{children:[Math.round(i),"% Loaded"]}),e.jsx(U,{children:e.jsx(C,{progress:i})})]})})}const N=c.lazy(()=>L(()=>I(()=>import("./Globe-Ca0-irBv-DlOgDdtF.js"),__vite__mapDeps([0,1,2])),w([0,1]))),Q=r.div`
  width: 100%;
`,V=r(b)`
